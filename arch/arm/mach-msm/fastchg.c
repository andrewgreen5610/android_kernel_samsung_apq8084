...
int force_fast_charge_init(void)
{
	...
	force_fast_charge		= FAST_CHARGE_FORCE_CUSTOM_MA; /* Forced fast charge enabled by default */
	...
	ac_charge_level			= AC_CHARGE_2200;	      /* Default AC charge level to 2200mA/h    */
	usb_charge_level		= USB_CHARGE_800;	      /* Default USB charge level to 800mA/h    */
